...
<div class="container">
	...
	<form class="form-horizontal" name="createForm" enctype="multipart/form-data" method="post" style="max-width:450px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" name="author" id="author" value = "${book.author}"  readonly class="form-control">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-4 control-label">Title</label>
			<div class="col-sm-8">
				<input type="text" name="title" id="title" value = "${book.title}" readonly class="form-control">
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" name="publisher" id="publisher" value = "${book.publisher}" readonly class="form-control">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-4 control-label">Year Of Publication</label>
			<div class="col-sm-8">
				<input type="text" name="yearOfPublication" id="yearOfPublication" value = "${book.yearOfPublication}" readonly class="form-control">
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" name="keyword" id="keyword" value = "${book.keyword}"  class="form-control">
			</div>
		</div>				
		<div class="form-group">

...
function getBookDetails(isbn) {
	document.isbnForm.action = "${pageContext.request.contextPath}/book/isbnbook/${sjsuId}/"+document.getElementById("isbn").value;
	document.forms["isbnForm"].submit();	
	  }
...
<div class="container">
	<form class="form-horizontal" name="isbnForm" enctype="multipart/form-data" method="post" style="max-width:450px;">
		<div class="form-group">
			...
			<div class="col-sm-4">
				<button type="button" value="Create" onclick="getBookDetails()" class="btn btn-success ">Add Using ISBN</button>
			</div>
		</div>											
	</form>
